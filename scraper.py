...
def scrape_listings(page, query):
    ...
    # Load the page and wait for network to settle fully
    page.goto(url, wait_until="networkidle", timeout=45000)
    time.sleep(5)  # Extra buffer for JS to render listing cards
    ...
    try:
        ...
        # Try a full page reload with longer wait
        ...
        try:
            ...
            print("  ⚠️  Still no listings after reload — sending screenshot to Telegram...")
            send_telegram_photo(page.screenshot())
            return []
